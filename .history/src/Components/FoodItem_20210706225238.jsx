  ...
  const cuisine = [
    {
      ...
      text: "Lorem ipsum dolor sint, molestiae  lorem  eum nihil laborum  soluta? Lorem ipsum dolor sint, molestiae  lorem  eum nihil laborum soluta? Quia, vero error Quia, vero error.",
      rating: 4,
    },
  ];

...
const FoodItem = () => {
  ...
  const cardRender = (card, index) => {
    return (
      <Card style={{ width: "18rem" }} key={index} className="container">
        <Card.Img variant="top" src="holder.js/100px180" src={card.image} className="Col-sm col-lg col-md " />
        <Card.Body>
  ...
  return <div className="row">{cuisine.map(cardRender)}</div>;
};
